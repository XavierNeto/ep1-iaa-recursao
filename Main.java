...
public class Main {
	...
	public static void generateImage(String inputFileName, String outputFileName) throws IOException {
		...
		while (scanner.hasNext()) {
			...
			// Adicionando os comandos do KOCH_CURVE e REGION_FILL para serem reconhecidos,
			// sendo essa a única alteração feita na classe Main

			if (command.equals("KOCH_CURVE")) {

				image.kochCurve(scanner.nextInt(), scanner.nextInt(), scanner.nextInt(), scanner.nextInt(),
						scanner.nextInt());
